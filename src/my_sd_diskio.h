...
bool sd_read_raw(uint8_t pdrv, uint8_t* buffer, uint32_t sector, size_t count=1);
bool sd_write_raw(uint8_t pdrv, uint8_t* buffer, uint32_t sector, size_t count=1);
